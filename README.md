...
<sub><em>* SimpleHF is not affiliated with or endorsed by the Qwen team. The model shown above is used solely to demonstrate SimpleHF's downloading capabilities.</em></sub>
